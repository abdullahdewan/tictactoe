  ...
  <div class="min-h-screen p-4 sm:p-8">
    ...
    <header class="flex justify-between items-center mb-12">
      <div class="flex items-center gap-4">
        <div
          class="w-12 h-12 bg-gradient-to-br from-primary-500 to-emerald-500 rounded-xl flex items-center justify-center"
        >
          <svg
          ...
          >
            <path
              ...
              stroke-width="2"
              d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m-3 0v3"
            ></path>
          </svg>
        </div>
        <h1
          ...
          <template #extra>
            ...
            >
              ...
              <div class="flex items-center gap-2">
                <code
                  class="text-xl font-mono font-bold text-primary-800 dark:text-primary-200 bg-white dark:bg-slate-700 px-3 py-1 rounded-lg"
                >
                  {{ gameStore.roomCode }}
                </code>
                <button
